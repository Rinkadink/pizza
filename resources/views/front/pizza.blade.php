  ...
  <div class="container">
    ...
    <div class="row mb-5">
      ...
      <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6"> <a href="{{route('front.buyNow',$pizza->id)}}" class="btn btn-block btn-danger">{{__('Buy now!!!')}}</a>
            </div>
            <div class="col-md-6"> <a href="{{route('front.addToCart', $pizza->id)}}" class="btn btn-block btn-primary">{{__('Add to cart')}}</a>
            </div>
        </div>
